...
export async function createTask(params: CreateTaskParams, embedToken: string): Promise<{ id: string; nextRunAt: string }> {
...
export async function listTasks(embedToken: string): Promise<Array<{ id: string; name: string; schedule: string; enabled: boolean; nextRunAt: string | null }>> {
